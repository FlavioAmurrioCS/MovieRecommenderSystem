...
public class Miner {
    ...
    public static HashMap<Integer, Movie> movieMap = new HashMap<>(13597);
    public static HashMap<String, Director> directorMap = new HashMap<>(5414);
    public static HashMap<String, Actor> actorMap = new HashMap<>(127095);
    public static HashMap<String, Genre> genreMap = new HashMap<>(27);
    public static HashMap<Integer, Tag> tagMap = new HashMap<>(7063);
    public static HashMap<Integer, String> tagList = new HashMap<>(17630);
    public static HashMap<Integer, User> userMap = new HashMap<>(2818);
